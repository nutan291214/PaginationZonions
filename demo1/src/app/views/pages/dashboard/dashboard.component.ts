...
import { Restaurant } from '../restaurants/_helpers/restaurant';
...
export class DashboardComponent implements OnInit {
   ...
   userLength: number;
   constructor(private router: Router, private layoutConfigService: LayoutConfigService, private restService: RestaurantService,
